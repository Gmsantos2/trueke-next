...
const Hero = () => {
    return (
        <div className=' container pt-10 flex h-[50vh] w-auto justify-between content-center md:flex-row mx-auto gap-9'>
            <div className='flex flex-col pl-8 font-montserrat justify-start text-[#0033FF]  w-[100vw] md:w-[60vw] 2xl:w-[50vw]'>   
                <h2 className='w-[70vw] max-md:w-[80vw] lg:w-[60vw] p-6 font-extrabold italic align-middle text-xl sm:text-2xl leading-tight tracking-wide'>
